...
- **[Advanced QueryBuilder](src/app/builder/README.md)**: Dynamic, type-safe query builder supporting filtering, searching, range queries, and cursor/offset pagination
